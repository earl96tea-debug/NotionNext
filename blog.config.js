...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '5-HT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '正在努力回想写作能力的社畜一枚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-x4cb.vercel.app/', // 网站地址
